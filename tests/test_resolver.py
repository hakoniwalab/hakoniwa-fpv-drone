...
rotor_layout:
  ...
  rotors:
    - {name: prop1, position_flu_m: [0.25, 0.0, 0.0], rotation_direction: 1}
    - {name: prop2, position_flu_m: [0.125, 0.216506, 0.0], rotation_direction: -1}
    - {name: prop3, position_flu_m: [-0.125, 0.216506, 0.0], rotation_direction: 1}
    - {name: prop4, position_flu_m: [-0.25, 0.0, 0.0], rotation_direction: -1}
    - {name: prop5, position_flu_m: [-0.125, -0.216506, 0.0], rotation_direction: 1}
    - {name: prop6, position_flu_m: [0.125, -0.216506, 0.0], rotation_direction: -1}
""",
                encoding="utf-8",
            )
